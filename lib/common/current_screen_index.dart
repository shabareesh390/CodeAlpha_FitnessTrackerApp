...
import 'package:flutter_daily_fitness_app_ui/screen/chart_screen.dart';
import 'package:flutter_daily_fitness_app_ui/screen/filter_screen.dart';
...
class CurrentScreenIndex extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    if (index == 1) return const ChartScreen();
    if (index == 2) return PlanScreen();
    if (index == 3) return const FilterScreen();
